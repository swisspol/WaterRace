...
#ifndef __INFINITY_AUDIO__
#define __INFINITY_AUDIO__

//CONSTANTES:

#define		kInfinityAudio_MaxVolume				1.0
#define		kInfinityAudio_NormalPitch				1.0
#define		kInfinityAudio_CenteredPanoramic		0.0
#define		kInfinityAudio_StoppedPitch				0.0

#define		kAnyClient								'????'

//STRUCTURES:

typedef long AudioID;
typedef AudioID* AudioIDPtr;
